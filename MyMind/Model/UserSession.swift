...
struct UserSession: Codable {
    ...
    static let testUserSession: UserSession = UserSession(token: "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..FuXZ3XtXqVAtFM1svs8Bdu_QimXg6eHUTLmx7G-qQs0", customerInfo: .init(id: 5, name: "聯合智網股份有限公司"), businessInfo: .init(id: 3, name: "品牌營銷處"), partnerInfo: .init(id: 3, name: "Anson"), employeeInfo: .init(id: 155, name: "tommy"))
}
