...
struct UserSession: Codable {
    ...
    static let testUserSession: UserSession = UserSession(token: "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..O0QwvGWAdN28qz2Ibgrm5GYKpLJlMNo1QyRANS2Hcaw", customerInfo: .init(id: 5, name: "聯合智網股份有限公司"), businessInfo: .init(id: 3, name: "品牌營銷處"), partnerInfo: .init(id: 3, name: "Anson"), employeeInfo: .init(id: 155, name: "tommy"))
}
